...
<?php if ( isset( $context->reviews_blocks ) ) : ?>
	<section class="jp-component jp-reviews">
		<div class="container">
			<div class="row">
				<div class="col">
								...
								<div class="jp-reviews-item">
									<div class="jp-reviews-item-author">
										<div class="jp-reviews-item-author-info">
											<div class="jp-reviews-item-author-image" style="background-image: url('<?php echo esc_attr( $item->photo['image'] ); ?>');" role="img" aria-label="<?php echo esc_attr( $item->photo['alt'] ); ?>">
											</div>
											<p class="jp-reviews-item-author-title"><?php echo esc_html( $item->heading ); ?></p>
										</div>
										<div class="jp-reviews-item-author-review">
